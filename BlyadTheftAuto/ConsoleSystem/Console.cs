...
namespace BlyadTheftAuto.ConsoleSystem
{
    internal class Console
    {
		#region VARIABLES
		private static ConsoleColor _notificationColor = ConsoleColor.Yellow;
        private static string CommandLine { get; } = ">" + System.Environment.UserName + ": ";
        public static string Watermark { get; } = $"BlyadTheftAuto v{Assembly.GetExecutingAssembly().GetName().Version.ToString()} ({Assembly.GetExecutingAssembly().GetLinkerTime()})";
        public static string Credits { get; } = "by Requi @ www.requi-dev.de";
		public static ConsoleColor NotificationColor
		{
			get
			{
        ...
        {
            ForegroundColor = _notificationColor;
            WriteLine(value);
            ForegroundColor = ConsoleColor.White;
        }
